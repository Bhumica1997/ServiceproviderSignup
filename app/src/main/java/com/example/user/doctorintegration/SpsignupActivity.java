...
//    }
    ...
    private void addUser() {
        ...
        double latitude=12.0000;
        double longitude=76.0000;
        String area="nagar";
        String discounts="40%";
        String rarestmedicine="orphan";
        double ratings=4.5;
        String time="9am-9pm";
        ...
        if (!TextUtils.isEmpty(name) && !TextUtils.isEmpty(phn) && !TextUtils.isEmpty(address)) {
            ...
            ServiceProviderInformation serviceproviders = new ServiceProviderInformation(name, address,email, password, phn, spinner, sspinner, ssspinner,latitude,longitude,ratings,time,rarestmedicine,discounts,area);
