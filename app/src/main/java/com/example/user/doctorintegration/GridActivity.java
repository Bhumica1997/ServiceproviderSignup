                ...
                public void onClick(View view) {
                    ...
                    switch (view.getId()) {
                        ...
                        case R.id.neuroid:
                            ...
                            mPref.edit().putString("gridval","neurologist").commit();
                        ...
                        case R.id.orthoid:
                            ...
                            mPref.edit().putString("gridval","orthopaedician").commit();
                        ...
                        case R.id.pregid:
                            intent = new Intent(GridActivity.this, MapsActivity.class);
                            mPref.edit().putString("gridval","gynaecologist").commit();
                            startActivity(intent);
                            break;
                        case R.id.kidid:
                            intent = new Intent(GridActivity.this, MapsActivity.class);
                        ...
                        case R.id. heartid:
                            intent = new Intent(GridActivity.this, MapsActivity.class);
                            mPref.edit().putString("gridval","cardiologist").commit();
                            startActivity(intent);
                            break;
                        case R.id.eyeid:
                            intent = new Intent(GridActivity.this, MapsActivity.class);
                            mPref.edit().putString("gridval","opthalmologist").commit();
                            startActivity(intent);
                            break;
                        ...
                        case R.id.generalid:
                            intent = new Intent(GridActivity.this, MapsActivity.class);
                            mPref.edit().putString("gridval","general physician").commit();
                            startActivity(intent);
                            break;
                        case R.id.dentistid:
                            intent = new Intent(GridActivity.this, MapsActivity.class);
