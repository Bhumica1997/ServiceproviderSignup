...
public class ServiceprovidersignupActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_serviceprovidersignup);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ServiceprovidersignupActivity.this, "Successfully registered", Toast.LENGTH_LONG).show();
                            addUser();
                            Intent toy2 = new Intent(ServiceprovidersignupActivity.this, NavigateActivity.class);
                            startActivity(toy2);

                        } else {
                            //display some message here
                            Toast.makeText(ServiceprovidersignupActivity.this, "Registration Error", Toast.LENGTH_LONG).show();
                        }
    ...
    private void init() {
        ...
        but2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent toy = new Intent(ServiceprovidersignupActivity.this, firebase.class);
                startActivity(toy);
            }
        });
    }
